...
import {
  ...
  FaStethoscope, FaPen, FaUniversity, FaFileAlt,
} from 'react-icons/fa';
...
const SCHOOL_LIST: SchoolTier[] = [
  {
    ...
    schools: [
      { name: 'Harvard Medical School', location: 'Boston, MA', mcat: 521, gpa: 3.97, logo: 'harvard.svg' },
      { name: 'Johns Hopkins SOM', location: 'Baltimore, MD', mcat: 521, gpa: 3.97, logo: 'johns_hopkins.svg' },
      { name: 'UCSF School of Medicine', location: 'San Francisco, CA', mcat: 517, gpa: 3.92, logo: 'ucsf.svg' },
      { name: 'Duke SOM', location: 'Durham, NC', mcat: 520, gpa: 3.91, logo: 'duke.svg' },
      { name: 'UPenn Perelman SOM', location: 'Philadelphia, PA', mcat: 522, gpa: 3.97, logo: 'upenn.svg' },
      { name: 'Stanford SOM', location: 'Stanford, CA', mcat: 520, gpa: 3.95, logo: 'stanford.svg' },
      { name: 'Columbia VP&S', location: 'New York, NY', mcat: 522, gpa: 3.95, logo: 'columbia.svg' },
      { name: 'NYU Grossman SOM', location: 'New York, NY', mcat: 523, gpa: 3.97, logo: 'nyu.svg' },
      { name: 'Vanderbilt SOM', location: 'Nashville, TN', mcat: 522, gpa: 3.97, logo: 'vanderbilt.svg' },
      { name: 'WashU SOM', location: 'St. Louis, MO', mcat: 521, gpa: 3.96, logo: 'washu.svg' },
      { name: 'Yale SOM', location: 'New Haven, CT', mcat: 522, gpa: 3.96, logo: 'yale.svg' },
      { name: 'U of Michigan Med', location: 'Ann Arbor, MI', mcat: 517, gpa: 3.92, logo: 'michigan.svg' },
      { name: 'Cleveland Clinic Lerner COM', location: 'Cleveland, OH', mcat: 520, gpa: 3.98, logo: 'cleveland_clinic.svg' },
      { name: 'Mayo Clinic Alix SOM', location: 'Rochester, MN', mcat: 522, gpa: 3.95, logo: 'mayo.svg' },
    ],
  },
  {
    label: 'Target',
    ...
    schools: [
      { name: 'Icahn SOM at Mt. Sinai', location: 'New York, NY', mcat: 519, gpa: 3.94, logo: 'icahn.svg' },
      { name: 'Northwestern Feinberg', location: 'Chicago, IL', mcat: 521, gpa: 3.94, logo: 'northwestern.svg' },
      { name: 'UChicago Pritzker SOM', location: 'Chicago, IL', mcat: 520, gpa: 3.94, logo: 'pritzker.svg' },
      { name: 'Weill Cornell Medicine', location: 'New York, NY', mcat: 520, gpa: 3.95, logo: 'weill_cornell.svg' },
      { name: 'Case Western Reserve', location: 'Cleveland, OH', mcat: 518, gpa: 3.93, logo: 'case_western.svg' },
      { name: 'UVA SOM', location: 'Charlottesville, VA', mcat: 520, gpa: 3.96, logo: 'university_of_virginia.svg' },
      { name: 'Brown Alpert Med', location: 'Providence, RI', mcat: 517, gpa: 3.88, logo: 'brown.svg' },
      { name: 'BU Chobanian & Avedisian', location: 'Boston, MA', mcat: 519, gpa: 3.91, logo: 'boston_university.svg' },
    ],
  },
  {
    label: 'Baseline',
    ...
    schools: [
      { name: 'Albert Einstein COM', location: 'Bronx, NY', mcat: 517, gpa: 3.91, logo: 'albert_einstein.svg' },
      { name: 'Dartmouth Geisel SOM', location: 'Hanover, NH', mcat: 516, gpa: 3.89, logo: 'geisel.svg' },
      { name: 'CU Anschutz SOM', location: 'Aurora, CO', mcat: 516, gpa: 3.89, logo: 'cu_anschutz.svg' },
      { name: 'Tufts University SOM', location: 'Boston, MA', mcat: 516, gpa: 3.90, logo: 'tufts.svg' },
      { name: 'Georgetown SOM', location: 'Washington, DC', mcat: 515, gpa: 3.90, logo: 'georgetown.svg' },
      { name: 'Creighton SOM', location: 'Omaha, NE', mcat: 515, gpa: 3.86, logo: 'creighton.svg' },
    ],
  },
];
...
const INITIAL_CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    icon: <FaEye />,
    activities: [
      { title: 'Denver Health Lowry Family Health Center', hours: 480, role: 'Clinical Observer', contact: 'Jessica M. Bull, MD, Medical Director · (303) 602-4545', location: '1001 Yosemite St, Denver, CO 80230', startDate: '06/12/2025', ongoing: true, description: 'I shadow Dr. Jessica Bull, who practices Family Medicine (260 hrs), and Dr. Gin-Ming Hsu, who practices Physical Medicine & Rehabilitation (220 hrs). With Dr. Bull, I observe primary care within a diverse, underserved population and how Dr. Bull works with specialists, nurses, and social workers for each patient. With Dr. Hsu, I observe regenerative therapies, pain management, and much more restoring patients\u2019 mobility and daily function. These experiences showed me medicine as both a clinical practice and a responsibility to lead. As both have served as medical directors, they shaped my understanding of how physicians impact healthcare far beyond the exam room.' },
    ],
  },
  {
    id: 'research',
  ...
  },
  {
    ...
    icon: <FaFileAlt />,
    activities: [
      { title: 'Serine recombinases are conserved genetic markers of antiphage defense systems', hours: 0, role: '3rd Author', contact: 'PI: Breck A. Duerkop, Ph.D. \u00b7 breck.duerkop@cuanschutz.edu', startDate: '10/30/2025', description: 'Andersen SE, Kirsch JM, Singh N, Garret SR, Whitney JC, Hesselberth JR, Duerkop BA. Serine recombinases are conserved genetic markers of antiphage defense systems. In revision, PLOS Biology. Preprint: bioRxiv. 2025. doi:10.1101/2025.10.07.681051' },
    ],
  },
  {
    id: 'presentations',
    ...
    activities: [
      { title: 'Research & Creative Activities Symposium (RaCAS)', hours: 0, role: 'Presenter', location: 'CU Denver', startDate: '04/26/2024', ongoing: true, description: 'At the 27th Annual RaCAS, I wasn\u2019t presenting. I was setting up poster boards, guiding presenters to their stations, and watching them defend their work. I thought: next year, that will be me. It was. At the 28th Annual, I presented \u201CKAP P-loop NTPase: A Novel Antiphage Defense System in Bacteria,\u201D describing how bacteria defend against bacteriophages, viruses now being developed to treat antibiotic-resistant infections. Out of over 300 presenters across five categories, my poster won Best in Natural & Physical Sciences, the same stage I had set up a year before. At the 29th, I returned to present new findings, and still came early to help the next wave of presenters find their place.' },
    ],
  },
  {
    id: 'teaching',
  ...
  },
  {
    ...
    icon: <FaBriefcase />,
    activities: [
      { title: 'Kumon Math & Reading Center of Denver — Lowry', hours: 355, role: 'Math/Reading Tutor', contact: 'Celeste Kupperbusch (Certified Instructor) · celestekupperbusch@ikumon.com · (303) 968-1025', location: '100 Spruce St, Unit 102, Denver, CO 80230', startDate: '11/01/2023', endDate: '10/14/2024', description: 'The first question I asked every student at Kumon was not about math. I asked who their role model was and what they wanted to become. Having attended this same center as a child, I returned to tutor students ages 3 to 18, most in middle school. I helped each student build a strong foundational understanding of a topic rather than relying on memorization, ensuring they truly understood the material before moving forward. When a student felt stuck, I brought them back to their own answer and reminded them that every problem they push through brings them one step closer to becoming that person. Kumon taught me that before you can help someone, you have to understand what matters to them.' },
    ],
  },
  {
    id: 'leadership',
    ...
    icon: <FaUsers />,
    activities: [
      { title: 'CU Denver Badminton Club', hours: 230, role: 'President / Founder', contact: 'Andrea Modica (Instructor, English Dept.) · andrea.modica@ucdenver.edu', location: 'Salazar Student Wellness Center, CU Denver', startDate: '02/24/2024', ongoing: true, description: 'Everyone deserves a community where nothing is expected but showing up. Between my responsibilities, I started playing badminton with students at the CU Denver gym and saw how much that break meant to everyone. I wanted to create a community where people could relax, so I founded the CU Denver Badminton Club, and we\u2019ve grown to 52 members. Each week, I run practices, teach beginners, organize tournaments, and plan events beyond the court. What I never anticipated was students from entirely different backgrounds bonding over a sport most had never tried. What began as my way to relax has become the reason students across campus show up every week, not just for the sport, but for each other.' },
      { title: 'Minority Association of Pre-Health Students (MAPS)', hours: 160, role: 'President', contact: 'ucdhealthcareers@ucdenver.edu', location: 'CU Denver', startDate: '08/15/2025', ongoing: true, description: 'The Minority Association of Pre-Health Students (MAPS) exists to strengthen the pipeline of minority students entering medicine. Serving as a member (24\u2019\u201325\u2019) and now as president (25\u2019\u201327\u2019) has allowed me to contribute to our mission of diversifying medicine through bi-weekly meetings, workshops, and direct connections with practicing physicians. Through our team\u2019s efforts, what started with 20 members has grown into a community of over 80 students who come to us for guidance and advice beyond our meetings. I am most proud of watching students who walked in uncertain leave with a plan, a mentor, and a community behind them. No student should have to navigate the path to medicine alone.' },
    ],
  },
  {
    id: 'artistic',
    ...
    icon: <FaMusic />,
    activities: [
      { title: 'Singing', hours: 0, role: 'Countertenor', startDate: '04/12/2010', ongoing: true, description: 'My father still has the video: me at five years old, standing in our living room, singing Adele\u2019s \u201CHello\u201D into his phone, off-key and fully committed. What started as a child performing for family became a constant in my life, the one thing that never needed a reason or an audience. Nine years of choir taught me I sing as a countertenor, a male voice in the highest registers, not what people expect. I sing at every family gathering, every drive, and between classes, I catch myself humming \u201CYou Got This\u201D by Peter Collins: keep growing, keep fighting, you\u2019ve got this. The songs are different now, but the kid standing in that living room, singing into his father\u2019s phone, is exactly the same.' },
    ],
  },
  {
    id: 'other',
    ...
    icon: <FaBook />,
    activities: [
      { title: 'PreMeder', hours: 0, role: 'Founder', ongoing: true, description: 'PreMeder is a free 501(c)(3) nonprofit I built to bring everything a pre-health student needs into one place: application tracking, recommenders tracking, course planning, and career resources for students across medicine, dentistry, pharmacy, and much more. I created it after growing tired of juggling through what felt like 10 tools, such as Notion, Google Sheets, and multiple more, just to stay organized as a pre-med. What started as my own solution became something bigger when I saw how many students faced the same problem. Over 12,000 pre-health students worldwide now use PreMeder, and what began as my own frustration has become something that makes this journey easier for others.' },
      { title: 'Programming', hours: 0, role: 'Software Architect', startDate: '06/01/2011', ongoing: true, description: 'I was six years old, watching TV. A robot said the color of a cup, a marker, and a water bottle, and I needed to know how. What started there has grown into 14 years of building at the intersection of technology and medicine. I built AI that analyzes pathology slides, tools that confirm biochemical pathways by cross-referencing papers, and a programming language I designed for machine learning. Every project begins the same way: a question I cannot answer yet. I chase the same curiosity that sat me in front of a screen at six, only now I build for patients and researchers who need better tools. To get to know me better and see what I\u2019m building, visit my portfolio and blog at navtej.dev.' },
    ],
  },
];
