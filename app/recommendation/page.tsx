...
const INITIAL_CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    activities: [
      ...
      { title: 'Dignity Hospice of Colorado', hours: 126, role: 'Volunteer', contact: 'Jennifer (Volunteer Coordinator) · (720) 222-3315', location: '400 E 84th Ave, Suite W-202, Thornton, CO 80229', ongoing: true, description: 'One in three patients at the end of life die alone. At Dignity Hospice, I make sure mine are not. I visit patients in nursing homes during their final stages, support their families through anticipatory grief, and navigate conversations about death and loss. My favorite moments are when patients light up as they share their proudest memories and the wisdom they have gathered over a lifetime. Each week, I sit with patients no one can cure, grow close to those I will lose, and return knowing the outcome will not change. Hospice taught me that the measure of a physician is not only in the lives they save, but in the dignity they protect when saving is no longer possible.' },
    ],
  },
  {
  ...
  },
  {
    ...
    icon: <FaFileAlt />,
    activities: [
      { title: 'Serine recombinases are conserved genetic markers of antiphage defense systems', hours: 0, role: '3rd Author', contact: 'PI: Breck A. Duerkop, Ph.D. \u00b7 breck.duerkop@cuanschutz.edu', startDate: '10/30/2025', description: 'Andersen SE, Kirsch JM, Singh N, Garret SR, Whitney JC, Hesselberth JR, Duerkop BA. Serine recombinases are conserved genetic markers of antiphage defense systems. In revision, PLOS Biology (PBIOLOGY-D-25-03514R1). Preprint: bioRxiv. 2025. doi:10.1101/2025.10.07.681051' },
    ],
  },
  {
    id: 'teaching',
  ...
  },
  {
    ...
    activities: [
      ...
      { title: 'Programming', hours: 0, startDate: '06/01/2011', ongoing: true, description: 'I was six years old, watching TV. A robot said the color of a cup, a marker, and a water bottle, and I needed to know how. What started there has grown into 14 years of building at the intersection of technology and medicine. I built AI that analyzes pathology slides, tools that confirm biochemical pathways by cross-referencing papers, and a programming language I designed for machine learning. Every project begins the same way: a question I cannot answer yet. I chase the same curiosity that sat me in front of a screen at six, only now I build for patients and researchers who need better tools. To get to know me better and see what I\u2019m building, visit my portfolio and blog at navtej.dev.' },
    ],
  },
];
